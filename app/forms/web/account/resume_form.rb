...
class Web::Account::ResumeForm < Resume
  ...
  attrs = %i[name hexlet_url github_url contact contact_email contact_phone summary skills_description awards_description english_fluency city relocation skill_list direction_list]
  nested_attrs = {
